  ...
  return <>
    <div className="form-container border">
      ...
      <div className="w-full px-6 py-2">
        <button type="submit" onClick={handleSubmit(onSubmit, onError)} className="w-full text-white bg-blue-500 hover:bg-blue-600 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-3 dark:bg-blue-600 dark:hover:bg-blue-700 ">
          <span>Sign Up</span>
        </button>
      </div>
    </div >
